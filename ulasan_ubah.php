        ...
        <form method="post">
            ...
            $id = $_GET['id'];
                if(isset($_POST['submit'])) {
                    ...
                    $ulasan= $_POST['ulasan'];
                    $rating= $_POST['rating'];
                    $query = mysqli_query($koneksi, "UPDATE ulasanbuku set id_buku='$id_buku', ulasanbuku='$ulasanbuku', rating='$rating'");
            ...
            <div class="row mb-3">
                <div class="col-md-2">Ulasan</div>
                    <div class="col-md-8">
                        <textarea name="ulasanbuku" rows="5" class="form-control"><?php echo $data['ulasanbuku']; ?></textarea>
                    </div>
                </div>
            <div class="row mb-3">
